# Reeds-Shepp integrated RRT* based on RRT-Star-Dubins
# Supports forward and reverse motion using reeds_shepp_path_planning
...
def reeds_shepp_steer(from_node, to_node):
...
def main():
    ...
    while True:
        ...
        new_node = reeds_shepp_steer(nearest, rand_node)
        if new_node:
